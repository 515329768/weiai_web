...
$www_file='/home/wwwroot/weiai/';//项目git路径
...
$access_token = 's7kjjhh8767laq29KLguandq212jjkgfdrrpipoinmw';//git中token

//接受的ip数组，也就是允许哪些IP访问这个文件 这里是gitlab服务器IP
$access_ip = array('140.143.250.124');//关闭验证
